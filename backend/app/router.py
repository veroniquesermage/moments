...
from app.routes import auth_route, group_route, gift_route, user_route, sharing_route, ideas_route, user_group_route, mail_route
...
router.include_router(mail_route.router)